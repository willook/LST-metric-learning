...
def text_prompt_openai_random():
    ...
    total_list = []
    for pasta_list in paste_text_map0: # 라벨(1) + 동의어(10)
        temp_list = []
        for item in pasta_list:
            temp_list.append(clip.tokenize(item))
        total_list.append(temp_list)
    return total_list # 120 x 11 of str
